			...
			<div class="wthree-foo-grids">
				...
				<div class="col-md-3 wthree-footer-grid">
					...
					<ul>
						...
						<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Terms of Use</a></li>
						<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Popular searches</a></li>	
						<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Privacy Policy</a></li>	
					</ul>
				</div>
				<div class="col-md-3 wthree-footer-grid">
					...
					<address>
						...
						<ul class="location">
							...
							<li><a href="mailto:info@example.com">mail@jobsfornepal</a></li>
						</ul>						
					</address>
				</div>
				<div class="clearfix"></div>
	...
	<div class="agileits-footer-bottom text-center">
		<div class="container">
			<div class="w3-footer-logo">
				<h1><a href="index.html"><span>Jobs</span>ForNepal</a></h1>
			</div>
			...
			<div class="copyrights">
				<p> © 2016 JobsForNepal. All Rights Reserved | Design by  <a href="http://sagars.com.np/"> Sagar Sapkota</a></p>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
...
<script type="text/javascript">
	$(document).ready(function() {
      ...
      $('#agileinfo_search').on('change', function () {
   ...
   /*   $('.hot-jobs-heading').click(function(){
      	$jobtype = $('.bread-portal').text();
      	console.log($jobtype);
      });*/
