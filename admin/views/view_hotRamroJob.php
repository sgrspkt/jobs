 ...
 require_once('model/hotRamroJobs.class.php');
 $viewobj=new HotRamroJobs();
 $views=$viewobj->viewHotRamroJobs();
/*echo '<pre>';
print_r($views);
die();*/
?>
    ...
    if(sizeof($views>0)){
      ...
      foreach($views as $value){
        ...
        <tr>
         ...
         <td><img src="<?php echo $value['logo'];?>" height="50px" width="50px"/> </td>
